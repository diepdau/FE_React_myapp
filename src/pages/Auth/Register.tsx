...
const RegisterUserSchema = object({
  ...
  confirmPassword: string().min(8, { message: "Please confirm your password" }),
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
      <FormProvider {...methods}>
        ...
        >
          <h1 className="text-4xl font-extrabold flex items-center justify-center my-6 tracking-tight text-foreground">
            Register
          </h1>
          ...
          <LoadingButton loading={store.requestLoading}>Sign Up</LoadingButton>
        </form>
      </FormProvider>
    </div>
  );
